...
RAMDISK_OUT="/home/brett/kern/usr/initramfs/ramdisk-i777.cpio"
...
#		zip -r Shift-1.0-CWM.zip ./ -x *.zip *.gitignore
...
echo "Building TWRP Kernel..."
		...
		zip -r Shift-TEST-TWRP.zip ./ -x *.zip *.gitignore
...
#		zip -r Shift-1.0-Slim.zip ./ -x *.zip *.gitignore
