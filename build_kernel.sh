...
export PARENT_DIR=`readlink -f /home/brett/kern`
export INITRAMFS_SOURCE=`readlink -f /home/brett/initramfs3`
export INITRAMFS_TMP="/tmp/initramfs-source"

# kernel
export ARCH=arm;
export USE_SEC_FIPS_MODE=true;
export KERNEL_CONFIG=kernel_defconfig;
...
export CROSS_COMPILE=/home/brett/Desktop/toolchains/arm-cortex_a9-linux-gnueabihf-linaro_4.7.4-2014.01/bin/arm-cortex_a9-linux-gnueabihf-;
